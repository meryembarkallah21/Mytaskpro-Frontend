...
mxGuide.prototype.move = function(bounds, delta, gridEnabled)
{
	if (this.states != null && (this.horizontal || this.vertical) && bounds != null && delta != null)
	{
		...
		else if (this.guideX != null)
		{
			...
			{
				var minY = Math.min(bounds.y + dy - this.graph.panDy, stateX.y);
				var maxY = Math.max(bounds.y + bounds.height + dy - this.graph.panDy, stateX.y + stateX.height);
			}
		...
		else if (this.guideY != null)
		{
			...
			{
				var minX = Math.min(bounds.x + dx - this.graph.panDx, stateY.x);
				var maxX = Math.max(bounds.x + bounds.width + dx - this.graph.panDx, stateY.x + stateY.width);
			}
